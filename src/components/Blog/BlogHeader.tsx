...
const BlogHeader = ({ tagList }: Props) => {
  ...
  return (
    <header
      className={`${isFocus && '!bg-gdsc-Red-500 !justify-start !items-start'} flex items-center gap-14 justify-between px-14 py-3.5 bg-white border-b border-gdsc-Grey-200`}
    >
      {/* 로고 및 제목 */}
