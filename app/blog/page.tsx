  ...
  return (
    <div data-pagefind-ignore='all'>
      ...
      {(await getPosts()).map((post: any) => (
        ...
        // <BoxCard key={post.route} route={post.route} title={post.frontMatter.title} author={post.frontMatter.author} date={post.frontMatter.date} comment={0} heart={0} view={0}  />
      ))}
    </div>
  );
}
