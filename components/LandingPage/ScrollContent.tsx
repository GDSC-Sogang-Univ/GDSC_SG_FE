    ...
    <>
      <div className="relative">
        ...
        <div className="absolute -bottom-6 left-[34px] z-10 mobile:-bottom-[10px] mobile:left-[13px]">
          ...
          <br />
          <div
            className="absolute -right-12 bottom-5 h-[41px] w-[41px] rotate-6 mobile:h-[22px] mobile:w-[22px] mobile:-right-7 mobile:bottom-3">
    ...
    <div className="flex flex-col gap-8">
      {data.map(({ title, detail }) => (
        <div key={title} className="flex flex-col gap-1">
          ...
          <p
            className="whitespace-pre-wrap break-keep text-gdsc-Grey-600 text-P3_KR mobile:text-P4_KR mobile:max-w-[291px]">
            {detail}
          </p>
        </div>
      ))}
